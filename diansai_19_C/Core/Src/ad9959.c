...
//    __HAL_RCC_GPIOD_CLK_ENABLE();                   //PD port clock enable
//    __HAL_RCC_GPIOG_CLK_ENABLE();                   //PD port clock enable

//    GPIO_InitStructure.Pin   = GPIO_PIN_10| GPIO_PIN_9;                             //Initialize PD0~12
...
//
//    GPIO_InitStructure.Pin   = GPIO_PIN_2 | GPIO_PIN_3 | GPIO_PIN_4 | GPIO_PIN_5 | GPIO_PIN_6 | GPIO_PIN_7 | GPIO_PIN_8;
...
void ReadData_9959(uint8_t RegisterAddress, uint8_t NumberofRegisters, uint8_t *RegisterData)
{
    ...
    GPIO_InitStructure.Pin =  GPIO_PIN_6,AD9959_SCLK_Pin;
    GPIO_InitStructure.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStructure.Mode = GPIO_MODE_OUTPUT_PP;
    HAL_GPIO_Init(AD9959_SCLK_GPIO_Port, &GPIO_InitStructure);
    ...
    GPIO_InitStructure.Pin =  AD9959_SDIO0_Pin;
    GPIO_InitStructure.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStructure.Mode = GPIO_MODE_INPUT;
    GPIO_InitStructure.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(AD9959_SDIO0_GPIO_Port, &GPIO_InitStructure);
